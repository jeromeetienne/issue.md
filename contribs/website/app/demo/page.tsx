export default function DemoPage() {
	return (
		<div className="section">
			<h1>CLI Demo</h1>
			<p>This walkthrough demonstrates a full issue lifecycle with commands you can run as-is.</p>

			<section className="section">
				<h2>Step 1: Create an issue</h2>
				<pre>
			...
			<section className="section">
				<h2>Step 2: Move status forward</h2>
				<pre>
...
npm run cli -- issue update --id 0001 --status done --repo issues`}</code>
			...
			<section className="section">
				<h2>Step 3: Track conversation</h2>
				<pre>
...
npm run cli -- comment list --issue-id 0001 --repo issues`}</code>
			...
			<section className="section">
				<h2>Step 4: Validate repository consistency</h2>
				<pre>
