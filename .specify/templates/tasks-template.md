...
- [ ] T010 Define issue front matter schema and validation rules
- [ ] T011 [P] Add canonical file path/naming strategy for issue documents
...
- [ ] T012 [P] [US1] Contract test for issue schema parsing in tests/contract/test_[name].py
- [ ] T013 [P] [US1] Integration test for issue lifecycle in tests/integration/test_[name].py
...
- [ ] T018 [US1] Add schema validation and error handling
